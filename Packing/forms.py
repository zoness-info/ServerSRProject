...
class ProductionRollDetailsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'runningrollstarttime' : forms.DateTimeInput(attrs={'class': 'form-control datepicker-range-time-24',}),
            'runningrollstoptime'  :forms.DateTimeInput(attrs={'class': 'form-control datepicker-range-time-24',}),
